                ...
                <ul class="p-top-modal__list">
                    ...
                    <li class="p-top-modal__item">
                        ...
                        <ul class="p-top-modal__sublist">
                            ...
                            <li class="p-top-modal__subitem">
                                <p class="p-top-modal__message">初回アクセス時にのみ再生されるローディングアニメーションは、GSAPのタイムラインで滑らかな同期とイージングを制御し、カラーグラデーションやシャドウの動的変化で視覚的な広がりを演出。訪問者に高品質で洗練された体験を提供します。</p>
                            </li>
                            <li class="p-top-modal__subitem">
                                <p class="p-top-modal__message">ヘッダーはスクロールに応じて動的に状態を切り替え、視認性と操作性を大幅に向上させています。
                                    特に、IntersectionObserverを用いて各セクションの視認状況を効率的に検知し、GSAPでスムーズな背景色や文字色、影の変化を制御しています。</p>
                            </li>
                            <li class="p-top-modal__subitem">
                            ...
                            <li class="p-top-modal__subitem">
                                <p class="p-top-modal__message">問い合わせセクションでは、表示時に最初の入力欄へ自動でフォーカスを当てることで、ユーザーがスムーズに入力を開始できるようにしています。フォーカス時には適切に視覚強調のクラスを付与し、キーボードユーザーやスクリーンリーダー利用者にも配慮しており、ラジオボタンなど特定要素は除外して誤った強調を防ぐ細やかな制御も行っています。また、タブキー操作で入力欄の区切りがわかりやすく、視覚的なフォーカスクラス付与により迷わずスムーズに入力できる工夫がされています。</p>
                            </li>
                        </ul>
                    </li>
                </ul>
